...
Overview
The claustrum is a highly interconnected subcortical structure, yet its circuit dynamics remain relatively unexplored. 
This project provides a computational framework to investigate:
Global and Local Dynamics: Simulating network states under different connectivity scales.
Inhibitory Connectivity: How specific inhibitory constraints affect neuronal population responses.
Circuit Motifs: Comparing different connectivity based on post-synaptic neurons: cortically-projecting (CC) vs. subcortically-projecting (CS) PNs.
