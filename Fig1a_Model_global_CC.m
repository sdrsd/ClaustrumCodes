...
% - global connectivity strength: CC
A = [.1,.33,.33, .33;               %PN->  PN PV SST VIP
    -1,-.57,-.28, -0.08;            %PV->  PN PV SST VIP
    -.9, -.35, -.29, -0.37;        %SST-> PN PV SST VIP
    -0.05, -.13, -.15, -.06];      %VIP-> PN PV SST VIP
...
%fig_suffix = ['globalCC_PV_SSTinh_and_VIPdis_alpha_', num2str(alpha(1))]   
fig_suffix = ['Fig1a_Model_global_CC']
