...
% - local connectivity strength: CS
A = [.1,.33,.33, .33;               %PN->  PN PV SST VIP
    -.09,-.31,-.14, -0.02;          %PV->  PN PV SST VIP
    -.25, -.25, -.24, -0.02;        %SST-> PN PV SST VIP
    -0.03, -.07, -.03, -.004];      %VIP-> PN PV SST VIP
...
fig_suffix = ['Fig2b_Model_local_CS'];
...
% % - IN motif _________________  CHECK INTERNEURON_________________________
% fig_suffix = ['local CC network PV 1 DISinhibition_ alpha_', num2str(alpha(1))]
% %disinhibition
